        ...
        function(scrollableTabsetConfig, $window, $interval, $timeout, $sce) {
            return {
                ...
                link: function($scope, $el) {
                    ...
                    $scope.scrollTo = function(element, change, duration, isLinear) {
                    ...
                    $scope.scrollButtonDown = function(direction, event) {
                        ...
                        $scope.scrollTo($scope.tabContainer, realScroll, 150, true);
                    ...
                    $scope.scrollTabIntoView = function(arg){
                        ...
                        if(tabToScroll) {
                            ...
                            if (leftPosition < 0) {
                                ...
                                $scope.scrollTo($scope.tabContainer, dif, 700);
